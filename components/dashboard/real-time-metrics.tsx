...
function MetricCard({ title, value, icon, trend = 'neutral', isLoading }: MetricCardProps) {
  ...
  const getTrendIcon = () => {
    switch (trend) {
      case 'up': return <TrendingUp className="h-4 w-4 text-custom-cyan" />;
  ...
  return (
    <div className="metric-card-enhanced card-neon-intense">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <MetricCard
        ...
        icon={<DollarSign className="h-5 w-5 text-custom-cyan" />}
      ...
      <MetricCard
        ...
        icon={<Activity className="h-5 w-5 text-custom-cyan" />}
        isLoading={metrics.isLoading}
      />
      ...
      <MetricCard
        ...
        icon={<TrendingUp className="h-5 w-5 text-custom-cyan" />}
        isLoading={metrics.isLoading}
      />
