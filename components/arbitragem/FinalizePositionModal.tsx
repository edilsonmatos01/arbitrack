      ...
      <DialogContent className="max-w-2xl card-enhanced card-neon text-white border border-custom-cyan/20">
        <DialogHeader>
          <DialogTitle className="text-white text-xl font-semibold flex items-center gap-2">
            ...
            Finalizar Posição - {position.symbol}
          </DialogTitle>
        </DialogHeader>

        <div className="space-y-6">
          {/* Informações da Posição */}
          <div className="bg-dark-card/50 p-4 rounded-lg border border-gray-700/50">
            <h3 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
              <span className="text-custom-cyan">ℹ️</span>
              Informações da Posição
            </h3>
          ...
          <div className="bg-dark-card/50 p-4 rounded-lg border-2 border-custom-cyan/50">
            <h3 className="text-lg font-semibold text-custom-cyan mb-3 flex items-center gap-2">
              <span className="text-custom-cyan">💰</span>
              Preços de Saída (Obrigatório) *
            </h3>
            <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-700/50">
            <button
              ...
              className="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-md transition-colors disabled:opacity-50 btn-enhanced"
            >
              Cancelar
            </button>
            <button
              ...
              className="px-6 py-2 bg-custom-cyan hover:bg-custom-cyan/90 text-black font-bold rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed btn-enhanced"
            >
