...
export default function InstantMaxSpreadCell({ symbol, currentSpread = 0 }: InstantMaxSpreadCellProps) {
  ...
  // Se há dados mas crosses é 0, mostrar como "Sem histórico"
  if (spreadData.crosses === 0) {
    return (
      <div className="flex items-center space-x-2">
        <div className="flex-1">
          <div className="text-sm font-bold text-gray-400">
  ...
  // Se há dados mas spMax é 0 mas crosses > 0, mostrar como "Spread baixo"
  if (spreadData.spMax === 0 && spreadData.crosses > 0) {
    return (
      <div className="flex items-center space-x-2">
        <div className="flex-1">
          <div className="text-sm font-bold text-gray-400">
  ...
  // Se há dados mas crosses < 2, mostrar como "Poucos dados"
  if (spreadData.crosses < 2) {
    return (
      <div className="flex items-center space-x-2">
        <div className="flex-1">
          <div className="text-sm font-bold text-gray-400">
