...
// Lista completa de pares Gate.io conforme especificado + paridades populares
export const GATEIO_PAIRS = [
  // Paridades populares que estavam faltando
  'ETH_USDT', 'SOL_USDT', 'BNB_USDT', 'XRP_USDT', 'DOGE_USDT', 'ADA_USDT', 'DOT_USDT', 'LINK_USDT', 'AVAX_USDT', 'MATIC_USDT',
  'UNI_USDT', 'LTC_USDT', 'BCH_USDT', 'ETC_USDT', 'FIL_USDT', 'ATOM_USDT', 'NEAR_USDT', 'FTM_USDT', 'ALGO_USDT', 'VET_USDT',
  'ICP_USDT', 'APT_USDT', 'OP_USDT', 'ARB_USDT', 'SUI_USDT', 'SEI_USDT', 'INJ_USDT', 'TIA_USDT', 'JUP_USDT', 'PYTH_USDT',
  ...
  // Paridades adicionais que estavam faltando
  'VANRY_USDT', 'EPIC_USDT', 'ZIG_USDT', 'XEM_USDT', 'REX_USDT', 'SHM_USDT', 'DGB_USDT', 'RWA_USDT'
];

// Lista completa de pares MEXC conforme especificado + paridades populares
